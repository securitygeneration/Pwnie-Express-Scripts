...
3. PwnPlug USB Command Execution: This mod allows you to run commands on the Pwnie Express PwnPlug by simply inserting a pre-configured USB stick (http://www.securitygeneration.com/security/pwn-plug-command-execution-using-usb-sticks/) 
